...
echo "  /app/bin/distributed_client frontend-1:60051 rm /mydir/file.txt"
echo "  /app/bin/distributed_client frontend-1:60051 rmdir /mydir"
echo "  /app/bin/distributed_client frontend-1:60051 ls /mydir"
echo ""
